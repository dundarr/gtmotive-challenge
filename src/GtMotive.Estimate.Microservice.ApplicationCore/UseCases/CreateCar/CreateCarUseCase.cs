...
namespace GtMotive.Estimate.Microservice.ApplicationCore.UseCases.CreateCar
{
    ...
    /// </summary>
    public class CreateCarUseCase : IUseCase<CreateCarInput>
    {
        private const int MaxManufactureAgeYears = 5;

        private readonly ICarRepository _carRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IOutputPortStandard<CreateCarOutput> _outputPort;
        ...
        public CreateCarUseCase(
            ...
            IOutputPortStandard<CreateCarOutput> outputPort)
        {
