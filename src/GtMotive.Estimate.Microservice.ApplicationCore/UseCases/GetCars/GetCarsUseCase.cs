...
namespace GtMotive.Estimate.Microservice.ApplicationCore.UseCases.GetCars
{
    ...
    /// </summary>
    public class GetCarsUseCase : IUseCase<GetCarsInput>
    {
        private readonly ICarRepository _carRepository;
        private readonly IOutputPortStandard<GetCarsOutput> _outputPort;
        ...
        public GetCarsUseCase(
            ...
            IOutputPortStandard<GetCarsOutput> outputPort)
        {
